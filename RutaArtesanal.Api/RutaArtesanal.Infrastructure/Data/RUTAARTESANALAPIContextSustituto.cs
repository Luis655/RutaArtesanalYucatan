...
namespace RutaArtesanal.Domain.Context.base2.sustituto
{
    public partial class RUTAARTESANALAPIContext2 : DbContext
    {
        public RUTAARTESANALAPIContext2()
        {
        }

        public RUTAARTESANALAPIContext2(DbContextOptions<RUTAARTESANALAPIContext> options)
            : base(options)
        {
        }
